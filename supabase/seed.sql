...
VALUES
    ...
    ('JC (V)', 'Sh. Vineet Kumar', 'Joint Commissioner', 'joint_commissioner', NULL, NULL, '', TRUE),
    ('JC (A)', 'Sh. Amanpreet Singh', 'Joint Commissioner', 'joint_commissioner', NULL, NULL, '', TRUE),
    ('JC (T)', 'Sh. Tapan Bhanot', 'Joint Commissioner', 'joint_commissioner', NULL, NULL, '', TRUE),
    ...
    ('SE (O&M)', 'Sh. Ekjot Singh', 'Superintending Engineer', 'superintending_engineer', NULL, 'Operations & Maintenance (O&M)', '', TRUE),
    ('SE (B&R)', 'Sh. Parveen Singla', 'Superintending Engineer', 'superintending_engineer', NULL, 'Bridges & Roads (B&R)', '', TRUE),
    ('MTP', 'Sh. Vijay Kumar', 'Municipal Town Planner', 'superintending_engineer', NULL, 'Town Planning (Building Branch)', '', TRUE),
    ('SE (SLG)', 'Sh. Shyam Lal Gupta', 'Superintending Engineer', 'superintending_engineer', NULL, NULL, '', TRUE),
    ('SE (HPS)', 'Sh. Harkiranpal Singh', 'Superintending Engineer', 'superintending_engineer', NULL, NULL, '', TRUE),
